...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function handleRouting() {
        ...
        // Reset semua section agar tersembunyi
        ...
        // Khusus Reset Tampilan Hasil Ujian
    ...
    // Listener Perubahan URL (Tombol Back Browser atau Klik Kartu)
    window.addEventListener('hashchange', handleRouting);
    
    // Memberikan fungsi klik pada Kartu Menu di Beranda
    ...
    onAuthStateChanged(auth, async (user) => {
        ...
        if (isAdmin) {
            ...
            // Menyembunyikan Kartu Menu Pengguna di Beranda jika login sebagai Guru
            ...
            // Mengubah nama Kartu Pengaturan menjadi Token Ujian di Beranda
    ...
    /* --- SISA KODE FUNGSI CRUD SEPERTI `loadDataMaster`, `loadDataPengguna`, `loadDataSoal`, dsb. TETAP SAMA KARENA SUDAH BERFUNGSI SEMPURNA SEBELUMNYA. (TIDAK PERLU DIUBAH) --- */
